      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="regoffice.php">Register Offices</a></li>
        ...
        <div class=" col-lg-offset-2 col-md-offset-2 col-lg-8 col-md-8 col-sm-12 col-xs-12">
            ...
            <div class="panel-heading"><span class="glyphicon glyphicon-user"></span>Register Office</div>
            <div class="panel-body">
            <form method="post" action="regof.php" id="frmregof">
            <div class="row">
            <div class="col-lg-12 col-md-12">
           
            <label class="control-label">Description</label>
            <input type="text" class="form-control" name="Ofdes"  placeholder="Enter description of office"/>
               </div>
            </div>
            </form>
            </div>
